...
public class FiJavaDomainTabelleModellGenerator extends AbstractJavaGenerator {
    ...
    private void modelFuerTabellenfeldErzeugen(final LowCodeModel modell,
        ...
        String packageLine = getPackageLineDomain(modell.getAnwendungskuerzel(),
                maske.getEntitaet());
        String packageFolder = "";
        if (!StringUtils.isEmpty(maske.getEntitaet()
                .getPaket())) {
            packageFolder = maske.getEntitaet()
                    .getPaket()
                    .toLowerCase() + "/";
        }
    ...
    private Set<JavaImport> variablenDefinitionErzeugen(final String shortApplicationName,
        ...
        imports.add(JavaImport.builder()
                ...
                .build());
        getModelImport(shortApplicationName, domain.getEntitaetByReference(feld.getZielEntitaet()),
                imports, entitaet);
        String nameCapitalized = domain.getEntitaetByReference(feld.getZielEntitaet())
                .getNameCapitalized();
        appendLn(sb,
                """
